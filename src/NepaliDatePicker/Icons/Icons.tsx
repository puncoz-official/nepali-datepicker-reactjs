...
export const Previous: FunctionComponent<IconBaseProps> = props => (
    <IconBase {...props}>
        <path fill="none" fillRule="evenodd" stroke="currentcolor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.4" d="M16.283 18.907L9.6 12l6.683-5.438"/>
    </IconBase>
)

export const Next: FunctionComponent<IconBaseProps> = props => {
    const rotationOrigin: Number = parseInt(props.size || "24") / 2

    return (
        <IconBase {...props}>
            <path transform={`rotate(180 ${rotationOrigin} ${rotationOrigin})`} fill="none" fillRule="evenodd" stroke="currentcolor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.4" d="M16.283 18.907L9.6 12l6.683-5.438"/>
        </IconBase>
    )
}

export const Today: FunctionComponent<IconBaseProps> = props => {
...
Previous.defaultProps = Next.defaultProps = Today.defaultProps = {
    size: "24",
    color: "currentColor",
}
